...
if CLIENT then
    ...
    -- WIG-WAG
        ...
        { offset = Vector(98.33,33.81,25.32), time = 0, duration = 0.5,  size = 50, color = Color(215,240,255) },
        { offset = Vector(98.33,-33.81,25.32), time = 0.5, duration = 0.5, size = 50, color = Color(215,240,255) },
