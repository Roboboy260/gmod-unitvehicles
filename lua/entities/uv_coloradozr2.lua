...
if CLIENT then
    ...
    -- WIG-WAG
        ...
        { offset = Vector( 100.45,33.79,29.08 ), color = Color(215,240,255), time = 0, duration = 0.5, size = 50 },
        { offset = Vector( 100.45,-33.79,29.08 ), color = Color(215,240,255), time = 0.5, duration = 0.5, size = 50 },
