...
if CLIENT then
    ...
    -- WIG-WAG
        ...
        { offset = Vector( -120.49,-35.11,34.48 ), color = Color(255,255,255), time = 0, duration = 0.5, size = 50 },
        { offset = Vector( -120.49,35.11,34.48 ), color = Color(255,255,255), time = 0.5, duration = 0.5, size = 50 },
